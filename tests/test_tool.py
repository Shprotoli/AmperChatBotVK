...
class TApiVK(AApiVk):
    async def parse_user_id(self, user_info: str) -> Optional[int]:
    ...
    async def send_messages_by_list(self, peer_id: int, user_id: int, messages_dict: tuple,
                                    status: str = None, index: int = None,
                                    id_request: int = None, admin_lvl_set: int = None, nick: str = None,
                                    new_nick: str = None, value_random: int = None,
                                    ) -> None: return
